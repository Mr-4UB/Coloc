                ...
                new Expanded(
                  child: new FlatButton(
                    ...
                    onPressed: () {
                      ...
                      _addOffre(
                          _adressXController.text,
                          _adressYController.text,
                          _teleController.text,
  ...
  void _addOffre(String adresseX, String adresseY, String tele, String prix,
    ...
    try {
      ...
      String _returnString =
          await OurDatabase().createOffre(_offre, context, _currentUser.uid);
    } catch (e) {}
  }
}
